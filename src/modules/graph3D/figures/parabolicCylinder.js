import { Figure, Point, Edge, Polygon, FigureBody } from '../index'

Figure.prototype.parabolicCylinder = (count = 10, point = new Point(0, 0, 0), color) => {
	const points = [];
	const edges = [];
	const polygons = [];
	const p = 5;
	...
	return new FigureBody(points, edges, polygons, 'parabolicCylinder', color);
}