	...
	constructor() {
		this.rpg = function () {
			...
			const situations = [
				{
					id: 1,
					image: "../modules/images/saske.jpg",
				...
				{
					id: 2,
					image: "../modules/images/sakura.jpg",
				...
				{
					id: 3,
					image: "../modules/images/naruto1.jpg",
